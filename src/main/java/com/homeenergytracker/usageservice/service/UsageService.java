package com.homeenergytracker.usageservice.service;

import com.homeenergytracker.kafka.event.AlertingEvent;
import com.homeenergytracker.usageservice.client.DeviceClient;
import com.homeenergytracker.usageservice.client.UserClient;
import com.homeenergytracker.usageservice.dto.DeviceDto;
import com.homeenergytracker.usageservice.dto.UsageDto;
import com.homeenergytracker.usageservice.dto.UserDto;
import com.homeenergytracker.usageservice.model.Device;
import com.homeenergytracker.usageservice.model.DeviceEnergy;
...
public class UsageService {
    ...
    public void aggregateDeviceEnergyUsage() {
        ...
        for (DeviceEnergy deviceEnergy : deviceEnergies) {
            try {
                ...
                deviceEnergy.setUserId(deviceResponse.id());
            } catch (Exception e) {
                log.warn("Failed to fetch device with ID: {}", deviceEnergy.getDeviceId());
            }
        }
    ...
    public UsageDto getXDaysUsageForUser(Long userId, int days) {
        log.info("Getting usage for user{} over past {} days", userId, days);
